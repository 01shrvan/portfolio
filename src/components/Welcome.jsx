  ...
  return (
    <section id="welcome">
      <p ref={subtitleRef} className="text-3xl font-georama">
        {renderText("yoo, i'm ", "text-3xl font-georama", 100)}
        <span className="italic font-mono inline-block text-center">
          shrvan
        </span>
        <span className="italic font-mono text-2xl inline-block text-center">
          (01shrvan)
        </span>
        {renderText(" welcome to my", "text-3xl font-georama", 100)}
      </p>
