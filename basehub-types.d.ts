...
export type BlockDocument = (Works | WorksComponent | Writings | WritingsComponent | _AgentStart | worksComponent_AsList | writingsComponent_AsList) & { __isUnion?: true }
...
export type BlockList = (Works | Writings | worksComponent_AsList | writingsComponent_AsList) & { __isUnion?: true }
...
export type WorksComponentOrderByEnum = '_sys_createdAt__ASC' | '_sys_createdAt__DESC' | '_sys_hash__ASC' | '_sys_hash__DESC' | '_sys_id__ASC' | '_sys_id__DESC' | '_sys_lastModifiedAt__ASC' | '_sys_lastModifiedAt__DESC' | '_sys_slug__ASC' | '_sys_slug__DESC' | '_sys_title__ASC' | '_sys_title__DESC' | 'description__ASC' | 'description__DESC' | 'href__ASC' | 'href__DESC' | 'role__ASC' | 'role__DESC' | 'untitled__ASC' | 'untitled__DESC'
...
export interface QueryGenqlSelection {
    ...
    writings?: (WritingsGenqlSelection & {
        __args?: {
            /** Filter by a field. */
...
export interface WorksGenqlSelection {
    ...
    _title?: boolean | number
    /** Returns the first item in the list, or null if the list is empty. Useful when you expect only one result. */
    item?: WorksComponentGenqlSelection
    /** Returns the list of items after filtering and paginating according to the arguments sent by the client. */
    items?: WorksComponentGenqlSelection
    __typename?: boolean | number
    __fragmentOn?: "Works"
}

export interface WorksComponentGenqlSelection {
    _analyticsKey?: {
        __args: {
            /**
             * The scope of the analytics key. Use `send` for just ingesting data. Use `query` if you need to show an analytics data in your website.
...
export interface _componentsGenqlSelection {
    works?: (worksComponent_AsListGenqlSelection & {
        __args?: {
            /** Filter by a field. */
            filter?: (WorksComponentFilterInput | null),
            /** Limit the number of items returned. Defaults to 500. */
    ...
    writings?: (writingsComponent_AsListGenqlSelection & {
        __args?: {
            /** Filter by a field. */
            filter?: (WritingsComponentFilterInput | null),
            /** Limit the number of items returned. Defaults to 500. */
